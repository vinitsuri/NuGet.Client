...
{
    /// <summary>
    /// A response to a get credential request.
    /// </summary>
    public sealed class GetCredentialResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCredentialResponse" /> class.
        /// </summary>
            ...
            string password)
        {
            ...
            PackageSourceUserName = username;
            PackageSourcePassword = password;
        }
    }
}