...
namespace NuGet.ProjectModel
{
    public static class LockFileExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<LockFileTarget> GetTargetGraphs(this ILockFileLogMessage message, LockFile assetsFile)
        {
            if (message == null)
            {
        ...
        /// </summary>
        public static IEnumerable<LockFileTargetLibrary> GetTargetLibraries(this ILockFileLogMessage message, LockFile assetsFile)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
