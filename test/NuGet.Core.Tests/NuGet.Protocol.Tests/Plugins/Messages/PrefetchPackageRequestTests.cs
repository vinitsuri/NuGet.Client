...
namespace NuGet.Protocol.Plugins.Tests
{
    public class PrefetchPackageRequestTests
    {
        ...
        [Theory]
        [InlineData("{\"PackageId\":\"a\",\"PackageSourceRepository\":\"b\",\"PackageVersion\":\"c\"}")]
        public void JsonDeserialization_ReturnsCorrectObject(string json)
        {
        ...
        public void JsonDeserialization_ThrowsForInvalidStringProperties(string json, string parameterName)
        {
            var exception = Assert.Throws<ArgumentException>(
