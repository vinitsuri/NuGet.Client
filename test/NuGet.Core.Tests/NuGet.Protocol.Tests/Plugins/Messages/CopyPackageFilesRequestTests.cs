...
{
    public class CopyPackageFilesRequestTests
    {
        [Theory]
        [InlineData(null)]
        [InlineData("")]
        ...
        public void JsonDeserialization_ReturnsCorrectObject()
        {
            ...
            var request = JsonSerializationUtilities.Deserialize<CopyPackageFilesRequest>(json);
        ...
        public void JsonDeserialization_ThrowsForInvalidStringArguments(string json, string parameterName)
        {
            var exception = Assert.Throws<ArgumentException>(
                () => JsonSerializationUtilities.Deserialize<CopyPackageFilesRequest>(json));
